...
from app.api.deps import CurrentPrincipal, ItemServiceDep
...
async def list_categories(
    current_user: CurrentPrincipal, item_service: ItemServiceDep
) -> list[str]:
...
async def read_item(
    current_user: CurrentPrincipal, item_service: ItemServiceDep, id: uuid.UUID
) -> Any:
...
async def create_item(
    *, current_user: CurrentPrincipal, item_service: ItemServiceDep, item_in: ItemCreate
) -> Any:
